    ...
    <>
      ...
      <div className="footer">
        <div className="social-icon">
          <a
            href="https://github.com/komalidevi810"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/komali-devi"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="mailto:komalidevi392@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <div className="personal-info">
          ...
          <h4>
            <span className="symbol">&#60;</span>Ch Komali Devi
